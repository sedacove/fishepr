...
function loadSalaryUsers() {
    $.ajax({
        url: BASE_URL + 'api/payroll.php?action=salary_users',
        method: 'GET',
        dataType: 'json',
...
function loadExtraWorkUsers(callback) {
    $.ajax({
        url: BASE_URL + 'api/payroll.php?action=users',
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function loadExtraWorks(isPaid) {
    ...
    $.ajax({
        url: BASE_URL + 'api/payroll.php?action=list&is_paid=' + (isPaid ? 1 : 0),
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function openExtraWorkModal(id = null) {
    ...
    if (id) {
        ...
        $.ajax({
            url: BASE_URL + 'api/payroll.php?action=get&id=' + id,
            method: 'GET',
            dataType: 'json',
            success: function(response) {
                if (response.success) {
...
function saveExtraWork() {
    ...
    let url = BASE_URL + 'api/payroll.php?action=create';
    if (currentEditId) {
        formData.id = currentEditId;
        url = BASE_URL + 'api/payroll.php?action=update';
    }
...
function deleteExtraWork(id) {
    ...
    $.ajax({
        url: BASE_URL + 'api/payroll.php?action=delete',
        method: 'POST',
        contentType: 'application/json',
...
function markExtraWorkPaid(id) {
    ...
    $.ajax({
        url: BASE_URL + 'api/payroll.php?action=mark_paid',
        method: 'POST',
        contentType: 'application/json',
        data: JSON.stringify({ id: id }),
        dataType: 'json',
