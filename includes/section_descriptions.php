...
if (!function_exists('renderSectionDescription')) {
    function renderSectionDescription(string $sectionKey): void
    {
        ...
        'feeds' => [
            'title' => 'Для чего нужен раздел «Корма»',
            'text' => [
                'Ведите справочник кормов: производитель, гранула, формулы выдачи и визуальные нормы кормления.',
                'Информация используется при настройке сессий: выбирайте корм и стратегию, чтобы операторы видели актуальные рекомендации.',
            ],
        ],
            'pools' => [
            ...
            'duty_calendar' => [
                ...
                'text' => [
                    ...
                    'Можно отмечать «голодовку» — дни без кормления. Информация видна всему персоналу и выделяется в календаре и на главной странице.',
