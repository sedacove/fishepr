...
<?php
// Подключаем шаблон модального окна для падежа
$modalId = 'recordModal';
$formId = 'recordForm';
...
function loadPools() {
    $.ajax({
        url: '<?php echo BASE_URL; ?>api/mortality.php?action=get_pools',
        method: 'GET',
        dataType: 'json',
...
function loadRecords(poolId) {
    ...
    $.ajax({
        url: '<?php echo BASE_URL; ?>api/mortality.php?action=list&pool_id=' + poolId,
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function openEditModal(id) {
    ...
    $.ajax({
        url: '<?php echo BASE_URL; ?>api/mortality.php?action=get&id=' + id,
        method: 'GET',
        dataType: 'json',
        success: function(response) {
            if (response.success) {
...
function deleteRecord(id) {
    ...
    $.ajax({
        url: '<?php echo BASE_URL; ?>api/mortality.php?action=delete',
        method: 'POST',
        contentType: 'application/json',
